...
```sh
fastchess -concurrency 8 -rounds 500 -games 2 -maxmoves 120 -recover -openings file=openings.pgn format=pgn plies=14 order=random -sprt elo0=0 elo1=10 alpha=0.05 beta=0.05 -engine name=new cmd=new -engine name=old cmd=old -each tc=30+0.5 restart=on
```
